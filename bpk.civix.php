 ...
 */
function _bpk_civix_civicrm_xmlMenu(&$files) {
  foreach (_bpk_civix_glob(__DIR__ . '/xml/Menu/*.xml') as $file) {
    $files[] = $file;
  }
}
 ...
 */
function _bpk_civix_civicrm_postInstall() {
  _bpk_civix_civicrm_config();
  if ($upgrader = _bpk_civix_upgrader()) {
 ...
 */
function _bpk_civix_civicrm_uninstall() {
  _bpk_civix_civicrm_config();
  if ($upgrader = _bpk_civix_upgrader()) {
 ...
 */
function _bpk_civix_civicrm_enable() {
  _bpk_civix_civicrm_config();
  if ($upgrader = _bpk_civix_upgrader()) {
 ...
 */
function _bpk_civix_civicrm_alterSettingsFolders(&$metaDataFolders = NULL) {
 ...
 */
function _bpk_civix_civicrm_entityTypes(&$entityTypes) {
